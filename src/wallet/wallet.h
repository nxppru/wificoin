...
#ifndef WIFICOIN_WALLET_WALLET_H
#define WIFICOIN_WALLET_WALLET_H
...
public:
     ...
     * on this wificoin node, and set to 0 for transactions that were created
...
#endif // WIFICOIN_WALLET_WALLET_H
