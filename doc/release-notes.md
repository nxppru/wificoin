WiFicoin Core version *0.15.1* is now available from:

  <https://wificoincore.org/bin/wificoin-core-0.15.1/>

or

  <https://wificoin.org/bin/wificoin-core-0.15.1/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/wificoin/wificoin/issues>

To receive security and update notifications, please subscribe to:

  <https://wificoincore.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/WiFicoin-Qt` (on Mac)
or `wificoind`/`wificoin-qt` (on Linux).
...
WiFicoin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

WiFicoin Core should also work on most other Unix-like systems but is not
...
A number of changes to the way WiFicoin Core deals with peer connections and invalid blocks
...
- #11433 `e169349` Restore wificoin-util-test py2 compatibility (MarcoFalke)
- #11308 `2e1ac70` zapwallettxes: Wait up to 3s for mempool reload (MarcoFalke)
- #10798 `716066d` test wificoin-cli (jnewbery)
...
- #11125 `812c870` Add wificoin-cli -stdin and -stdinrpcpass functional tests (promag)
- #11077 `1d80d1e` fix timeout issues from TestNode (jnewbery)
- #11078 `f1ced0d` Make p2p-leaktests.py more robust (jnewbery)
- #11210 `f3f7891` Stop test_wificoin-qt touching ~/.wificoin (MeshCollider)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in wificoin-tx [multisig] output adds (TheBlueMatt)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/wificoin/).
