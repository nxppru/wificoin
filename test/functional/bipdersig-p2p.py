...
class BIP66Test(WiFicoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # wificoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and wificoind produces more specific reject
            # reasons.
