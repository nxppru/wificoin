...
#ifndef WIFICOIN_TEST_SCRIPTNUM10_H
#define WIFICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from WiFicoin Core 0.10.0, for cross-comparison.
 */
public:
