...
This document provides guidelines for internationalization of the WiFicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wificoin_en.ts` remains unchanged.
