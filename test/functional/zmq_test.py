...
from test_framework.test_framework import WiFicoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (WiFicoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that wificoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("wificoind has not been built with zmq enabled.")
