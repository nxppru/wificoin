...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WiFicoinTestFramework
    pass

class ExampleTest(WiFicoinTestFramework):
    # Each functional test is a subclass of the WiFicoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WiFicoinTestFramework class so other tests can use it."""
