...
#ifndef WIFICOIN_QT_WIFICOINUNITS_H
#define WIFICOIN_QT_WIFICOINUNITS_H
...
/** WiFicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WiFicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WiFicoinUnits(QObject *parent);

    /** WiFicoin units.
      @note Source: https://en.wificoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WFC,
...
typedef WiFicoinUnits::Unit WiFicoinUnit;

#endif // WIFICOIN_QT_WIFICOINUNITS_H
