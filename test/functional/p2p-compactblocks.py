#!/usr/bin/env python3
# Copyright (c) 2016 The WiFicoin Core developers
...
# TestNode: A peer we use to send messages to wificoind, and store responses.
...
class CompactBlocksTest(WiFicoinTestFramework):
    ...
    # This test actually causes wificoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that wificoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for wificoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # wificoind will not send blocktxn responses for blocks whose height is
